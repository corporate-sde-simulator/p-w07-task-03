...
> **Welcome to Product-Track Week 7, Task 3!**
...
| `src/dependencyResolver.py` | Main source code - **has bugs to fix** |
| `src/graphBuilder.py` | Supporting code - **may also have bugs** |
| `tests/test_dependencyResolver.py` | Test file - **add your tests here** |
...
### Incident - `src/dependencyResolver.py`
**User Report / Alert:**
> "This builds the order backwards — it appends to front instead of back."
...
### Incident - `src/dependencyResolver.py`
**User Report / Alert:**
> "Returns False when cycle IS found, True when no cycle."
...
### Incident - `src/dependencyResolver.py`
**User Report / Alert:**
> "Returns True here (no cycle case) — should return False"
